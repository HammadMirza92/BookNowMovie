    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 3, "This is the Life movie description", new DateTime(2023, 3, 30, 21, 16, 28, 608, DateTimeKind.Local).AddTicks(1181), "http://dotnethow.net/images/movies/movie-3.jpeg", 6, "Life", 39, 3, new DateTime(2023, 3, 10, 21, 16, 28, 608, DateTimeKind.Local).AddTicks(1163), 23 },
                    { 2, 1, "This is the Shawshank Redemption description", new DateTime(2023, 3, 23, 21, 16, 28, 608, DateTimeKind.Local).AddTicks(1203), "http://dotnethow.net/images/movies/movie-1.jpeg", 1, "The Shawshank Redemption", 29, 1, new DateTime(2023, 3, 20, 21, 16, 28, 608, DateTimeKind.Local).AddTicks(1202), 29 },
                    { 3, 4, "This is the Ghost movie description", new DateTime(2023, 3, 27, 21, 16, 28, 608, DateTimeKind.Local).AddTicks(1218), "http://dotnethow.net/images/movies/movie-4.jpeg", 7, "Ghost", 67, 4, new DateTime(2023, 3, 20, 21, 16, 28, 608, DateTimeKind.Local).AddTicks(1217), 99 },
                    { 4, 1, "This is the Race movie description", new DateTime(2023, 3, 15, 21, 16, 28, 608, DateTimeKind.Local).AddTicks(1232), "http://dotnethow.net/images/movies/movie-6.jpeg", 6, "Race", 71, 2, new DateTime(2023, 3, 10, 21, 16, 28, 608, DateTimeKind.Local).AddTicks(1231), 88 },
                    { 5, 1, "This is the Scoob movie description", new DateTime(2023, 3, 18, 21, 16, 28, 608, DateTimeKind.Local).AddTicks(1247), "http://dotnethow.net/images/movies/movie-7.jpeg", 5, "Scoob", 90, 3, new DateTime(2023, 3, 10, 21, 16, 28, 608, DateTimeKind.Local).AddTicks(1246), 43 },
                    { 6, 1, "This is the Cold Soles movie description", new DateTime(2023, 4, 9, 21, 16, 28, 608, DateTimeKind.Local).AddTicks(1263), "http://dotnethow.net/images/movies/movie-8.jpeg", 3, "Cold Soles", 44, 5, new DateTime(2023, 3, 23, 21, 16, 28, 608, DateTimeKind.Local).AddTicks(1262), 83 }
                });
